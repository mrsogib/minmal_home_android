...
class PrefsHelper(context: Context) {
    ...
    fun getBgColor(): Int {
        ...
        return if (isDarkTheme()) android.graphics.Color.BLACK else android.graphics.Color.WHITE
    }

    fun getTextColor(): Int {
        val custom = prefs.getString(KEY_CUSTOM_TEXT, null)
        if (custom != null) return android.graphics.Color.parseColor(custom)
        return if (isDarkTheme()) android.graphics.Color.WHITE else android.graphics.Color.BLACK
    }
